...
public class Build {
    ...
    public static final String LINEAGEOS_VERSION = getString("ro.nenggala.version");

    /** A build ID string meant for displaying to the user */
    public static final String LINEAGEOS_DISPLAY_VERSION = getString("ro.nenggala.display.version");
    ...
    public static class NENGGALA_VERSION {
        ...
        public static final int SDK_INT = SystemProperties.getInt(
                "ro.nenggala.build.version.plat.sdk", 0);
    }
